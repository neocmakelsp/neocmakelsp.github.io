// https://jsr.io/@hono/hono/4.5.5/src/adapter/aws-lambda/handler.ts
import crypto from "node:crypto";

// https://jsr.io/@hono/hono/4.5.5/src/utils/encode.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/utils/body.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/utils/url.ts
var splitPath = (path) => {
...
// https://jsr.io/@hono/hono/4.5.5/src/request.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/utils/html.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/context.ts
...
var Context = class {
  ...
  html = (html2, arg, headers) => {
    ...
    if (typeof html2 === "object") {
      ...
      if (html2 instanceof Promise) {
        return html2.then((html3) => resolveCallback(html3, HtmlEscapedCallbackPhase.Stringify, false, {})).then((html3) => {
...
// https://jsr.io/@hono/hono/4.5.5/src/compose.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/router.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/hono-base.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/router/reg-exp-router/node.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/router/reg-exp-router/trie.ts
var Trie = class {
  context = { varIndex: 0 };
  root = new Node();
...
// https://jsr.io/@hono/hono/4.5.5/src/router/reg-exp-router/router.ts
var emptyParam = [];
...
// https://jsr.io/@hono/hono/4.5.5/src/router/smart-router/router.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/router/trie-router/node.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/router/trie-router/router.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/hono.ts
...
// https://jsr.io/@hono/hono/4.5.5/src/helper/html/index.ts
...
// src/mycomponent.tsx
function Home({ children, label }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", null, label), children);
}

// src/index.tsx
var app = new Hono2();
var Layout = ({ title, children }) => html`<!DOCTYPE html>
  <html>
    <head>
      <title>${title}</title>
    </head>
...
app.get("/", (c) => {
  return c.html(
    /* @__PURE__ */ React.createElement(Layout, { title: "Hello Deno!" }, /* @__PURE__ */ React.createElement("h1", null, "Hono JSX example"), /* @__PURE__ */ React.createElement(Home, { label: "abcd" }, /* @__PURE__ */ React.createElement("h1", null, "ABCD")))
  );
});
