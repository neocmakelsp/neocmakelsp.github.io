...
function DocTopBar({ children }) {
  return /* @__PURE__ */ u2(topbar_default, { isdark: true, children });
}
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/common/utils.mjs
var utils_exports = {};
...
// ../../../.cache/deno/deno_esbuild/mdurl@2.0.0/node_modules/mdurl/index.mjs
var mdurl_exports = {};
...
// ../../../.cache/deno/deno_esbuild/mdurl@2.0.0/node_modules/mdurl/lib/decode.mjs
var decodeCache = {};
function getDecodeCache(exclude) {
  ...
  for (let i4 = 0; i4 < 128; i4++) {
    const ch = String.fromCharCode(i4);
    cache.push(ch);
  }
  for (let i4 = 0; i4 < exclude.length; i4++) {
    const ch = exclude.charCodeAt(i4);
...
function decode(string, exclude) {
  ...
  return string.replace(/(%[a-f0-9]{2})+/gi, function(seq) {
    let result3 = "";
    for (let i4 = 0, l3 = seq.length; i4 < l3; i4 += 3) {
      const b1 = parseInt(seq.slice(i4 + 1, i4 + 3), 16);
      if (b1 < 128) {
        result3 += cache[b1];
        continue;
      }
      if ((b1 & 224) === 192 && i4 + 3 < l3) {
        const b2 = parseInt(seq.slice(i4 + 4, i4 + 6), 16);
        if ((b2 & 192) === 128) {
          const chr = b1 << 6 & 1984 | b2 & 63;
          if (chr < 128) {
            result3 += "\uFFFD\uFFFD";
          } else {
            result3 += String.fromCharCode(chr);
          }
          i4 += 3;
          continue;
        }
      ...
      if ((b1 & 240) === 224 && i4 + 6 < l3) {
        const b2 = parseInt(seq.slice(i4 + 4, i4 + 6), 16);
        const b3 = parseInt(seq.slice(i4 + 7, i4 + 9), 16);
      ...
      if ((b1 & 248) === 240 && i4 + 9 < l3) {
        const b2 = parseInt(seq.slice(i4 + 4, i4 + 6), 16);
        const b3 = parseInt(seq.slice(i4 + 7, i4 + 9), 16);
        const b4 = parseInt(seq.slice(i4 + 10, i4 + 12), 16);
        if ((b2 & 192) === 128 && (b3 & 192) === 128 && (b4 & 192) === 128) {
          ...
          if (chr < 65536 || chr > 1114111) {
            ...
            chr -= 65536;
            result3 += String.fromCharCode(55296 + (chr >> 10), 56320 + (chr & 1023));
          }
          i4 += 9;
          continue;
        }
...
// ../../../.cache/deno/deno_esbuild/mdurl@2.0.0/node_modules/mdurl/lib/encode.mjs
var encodeCache = {};
...
function encode(string, exclude, keepEscaped) {
  ...
  let result3 = "";
  for (let i4 = 0, l3 = string.length; i4 < l3; i4++) {
    const code2 = string.charCodeAt(i4);
    if (keepEscaped && code2 === 37 && i4 + 2 < l3) {
      if (/^[0-9a-f]{2}$/i.test(string.slice(i4 + 1, i4 + 3))) {
        result3 += string.slice(i4, i4 + 3);
        i4 += 2;
        continue;
      }
    }
    ...
    if (code2 >= 55296 && code2 <= 57343) {
      if (code2 >= 55296 && code2 <= 56319 && i4 + 1 < l3) {
        const nextCode = string.charCodeAt(i4 + 1);
        if (nextCode >= 56320 && nextCode <= 57343) {
          result3 += encodeURIComponent(string[i4] + string[i4 + 1]);
          i4++;
          continue;
        }
      }
    ...
    result3 += encodeURIComponent(string[i4]);
  }
  return result3;
}
...
// ../../../.cache/deno/deno_esbuild/mdurl@2.0.0/node_modules/mdurl/lib/format.mjs
function format(url) {
  let result3 = "";
  result3 += url.protocol || "";
  result3 += url.slashes ? "//" : "";
  result3 += url.auth ? url.auth + "@" : "";
  if (url.hostname && url.hostname.indexOf(":") !== -1) {
    result3 += "[" + url.hostname + "]";
  } else {
    result3 += url.hostname || "";
  }
  result3 += url.port ? ":" + url.port : "";
  result3 += url.pathname || "";
  result3 += url.search || "";
  result3 += url.hash || "";
  return result3;
}

// ../../../.cache/deno/deno_esbuild/mdurl@2.0.0/node_modules/mdurl/lib/parse.mjs
function Url() {
  this.protocol = null;
  this.slashes = null;
  this.auth = null;
...
Url.prototype.parse = function(url, slashesDenoteHost) {
  ...
  if (!hostlessProtocol[proto] && (slashes || proto && !slashedProtocol[proto])) {
    let hostEnd = -1;
    for (let i4 = 0; i4 < hostEndingChars.length; i4++) {
    ...
    hostEnd = -1;
    for (let i4 = 0; i4 < nonHostChars.length; i4++) {
    ...
    if (!ipv6Hostname) {
      ...
      for (let i4 = 0, l3 = hostparts.length; i4 < l3; i4++) {
        const part = hostparts[i4];
        if (!part) {
          continue;
        }
        if (!part.match(hostnamePartPattern)) {
          ...
          if (!newpart.match(hostnamePartPattern)) {
            const validParts = hostparts.slice(0, i4);
            const notHost = hostparts.slice(i4 + 1);
...
// ../../../.cache/deno/deno_esbuild/uc.micro@2.1.0/node_modules/uc.micro/index.mjs
var uc_exports = {};
__export(uc_exports, {
  Any: () => regex_default,
  Cc: () => regex_default2,
...
// ../../../.cache/deno/deno_esbuild/uc.micro@2.1.0/node_modules/uc.micro/properties/Any/regex.mjs
var regex_default = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/;

// ../../../.cache/deno/deno_esbuild/uc.micro@2.1.0/node_modules/uc.micro/categories/Cc/regex.mjs
var regex_default2 = /[\0-\x1F\x7F-\x9F]/;

// ../../../.cache/deno/deno_esbuild/uc.micro@2.1.0/node_modules/uc.micro/categories/Cf/regex.mjs
var regex_default3 = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/;

// ../../../.cache/deno/deno_esbuild/uc.micro@2.1.0/node_modules/uc.micro/categories/P/regex.mjs
var regex_default4 = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/;

// ../../../.cache/deno/deno_esbuild/uc.micro@2.1.0/node_modules/uc.micro/categories/S/regex.mjs
var regex_default5 = /[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBC2\uFD40-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA]/;

// ../../../.cache/deno/deno_esbuild/uc.micro@2.1.0/node_modules/uc.micro/categories/Z/regex.mjs
var regex_default6 = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/;

// ../../../.cache/deno/deno_esbuild/entities@4.5.0/node_modules/entities/lib/esm/generated/decode-data-html.js
...
// ../../../.cache/deno/deno_esbuild/entities@4.5.0/node_modules/entities/lib/esm/generated/decode-data-xml.js
var decode_data_xml_default = new Uint16Array(
  // prettier-ignore
  "\u0200aglq	\x1B\u026D\0\0p;\u4026os;\u4027t;\u403Et;\u403Cuot;\u4022".split("").map((c3) => c3.charCodeAt(0))
);

// ../../../.cache/deno/deno_esbuild/entities@4.5.0/node_modules/entities/lib/esm/decode_codepoint.js
var _a;
...
// ../../../.cache/deno/deno_esbuild/entities@4.5.0/node_modules/entities/lib/esm/decode.js
var CharCodes;
(function(CharCodes2) {
...
// ../../../.cache/deno/deno_esbuild/entities@4.5.0/node_modules/entities/lib/esm/generated/encode-html.js
function restoreDiff(arr) {
  for (let i4 = 1; i4 < arr.length; i4++) {
    arr[i4][0] += arr[i4 - 1][0] + 1;
  }
  return arr;
}
...
// ../../../.cache/deno/deno_esbuild/entities@4.5.0/node_modules/entities/lib/esm/escape.js
  ...
  return function escape3(data) {
    ...
    while (match2 = regex.exec(data)) {
      if (lastIdx !== match2.index) {
        result3 += data.substring(lastIdx, match2.index);
      }
      result3 += map2.get(match2[0].charCodeAt(0));
      lastIdx = match2.index + 1;
    }
    return result3 + data.substring(lastIdx);
  };
}
...
// ../../../.cache/deno/deno_esbuild/entities@4.5.0/node_modules/entities/lib/esm/index.js
var EntityLevel;
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/helpers/index.mjs
var helpers_exports = {};
...
function parseLinkDestination(str, start, max) {
  ...
  if (str.charCodeAt(pos) === 60) {
    ...
    while (pos < max) {
      ...
      if (code2 === 62) {
        result3.pos = pos + 1;
        result3.str = unescapeAll(str.slice(start + 1, pos));
        result3.ok = true;
        return result3;
      }
  ...
  result3.str = unescapeAll(str.slice(start, pos));
  result3.pos = pos;
  result3.ok = true;
  return result3;
}
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/renderer.mjs
var default_rules = {};
...
default_rules.fence = function(tokens, idx, options, env, slf) {
  ...
  if (info) {
    const i4 = token.attrIndex("class");
...
Renderer.prototype.renderAttrs = function renderAttrs(token) {
  ...
  for (i4 = 0, l3 = token.attrs.length; i4 < l3; i4++) {
    result3 += " " + escapeHtml(token.attrs[i4][0]) + '="' + escapeHtml(token.attrs[i4][1]) + '"';
  }
  return result3;
};
Renderer.prototype.renderToken = function renderToken(tokens, idx, options) {
  ...
  result3 += (token.nesting === -1 ? "</" : "<") + token.tag;
  result3 += this.renderAttrs(token);
...
Renderer.prototype.renderInline = function(tokens, options, env) {
  ...
  for (let i4 = 0, len = tokens.length; i4 < len; i4++) {
    const type = tokens[i4].type;
    if (typeof rules[type] !== "undefined") {
      result3 += rules[type](tokens, i4, options, env, this);
    } else {
      result3 += this.renderToken(tokens, i4, options);
    }
  }
  return result3;
};
Renderer.prototype.renderInlineAsText = function(tokens, options, env) {
  let result3 = "";
  for (let i4 = 0, len = tokens.length; i4 < len; i4++) {
    switch (tokens[i4].type) {
      case "text":
        result3 += tokens[i4].content;
        break;
      case "image":
        result3 += this.renderInlineAsText(tokens[i4].children, options, env);
        break;
      case "html_inline":
      case "html_block":
        result3 += tokens[i4].content;
...
Renderer.prototype.render = function(tokens, options, env) {
  ...
  for (let i4 = 0, len = tokens.length; i4 < len; i4++) {
    const type = tokens[i4].type;
    if (type === "inline") {
      result3 += this.renderInline(tokens[i4].children, options, env);
    } else if (typeof rules[type] !== "undefined") {
      result3 += rules[type](tokens, i4, options, env, this);
    } else {
      result3 += this.renderToken(tokens, i4, options, env);
    }
  }
  return result3;
};
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/ruler.mjs
function Ruler() {
  this.__rules__ = [];
  this.__cache__ = null;
}
Ruler.prototype.__find__ = function(name) {
  for (let i4 = 0; i4 < this.__rules__.length; i4++) {
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/token.mjs
...
Token.prototype.attrIndex = function attrIndex(name) {
  ...
  for (let i4 = 0, len = attrs.length; i4 < len; i4++) {
    if (attrs[i4][0] === name) {
      return i4;
    }
  }
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/state_core.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/normalize.mjs
var NEWLINES_RE = /\r\n?|\n/g;
var NULL_RE = /\0/g;
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/block.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/inline.mjs
function inline(state) {
  const tokens = state.tokens;
  for (let i4 = 0, l3 = tokens.length; i4 < l3; i4++) {
    const tok = tokens[i4];
    if (tok.type === "inline") {
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/linkify.mjs
...
function linkify(state) {
  ...
  for (let j3 = 0, l3 = blockTokens.length; j3 < l3; j3++) {
    ...
    for (let i4 = tokens.length - 1; i4 >= 0; i4--) {
      ...
      if (currentToken.type === "text" && state.md.linkify.test(currentToken.content)) {
        ...
        blockTokens[j3].children = tokens = arrayReplaceAt(tokens, i4, nodes);
      }
    }
  }
}

// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/replacements.mjs
var RARE_RE = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/;
...
function replace_scoped(inlineTokens) {
  ...
  for (let i4 = inlineTokens.length - 1; i4 >= 0; i4--) {
    const token = inlineTokens[i4];
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/smartquotes.mjs
var QUOTE_TEST_RE = /['"]/;
var QUOTE_RE = /['"]/g;
var APOSTROPHE = "\u2019";
...
function process_inlines(tokens, state) {
  ...
  for (let i4 = 0; i4 < tokens.length; i4++) {
    ...
    const thisLevel = tokens[i4].level;
    ...
    OUTER:
      while (pos < max) {
        ...
        let lastChar = 32;
        if (t3.index - 1 >= 0) {
          lastChar = text4.charCodeAt(t3.index - 1);
        } else {
          for (j3 = i4 - 1; j3 >= 0; j3--) {
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_core/text_join.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/parser_core.mjs
var _rules = [
  ["normalize", normalize],
  ["block", block],
  ["inline", inline],
...
function Core() {
  ...
  for (let i4 = 0; i4 < _rules.length; i4++) {
    this.ruler.push(_rules[i4][0], _rules[i4][1]);
  }
}
Core.prototype.process = function(state) {
  const rules = this.ruler.getRules("");
  for (let i4 = 0, l3 = rules.length; i4 < l3; i4++) {
    rules[i4](state);
  }
};
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_block/state_block.mjs
function StateBlock(src, md3, env, tokens) {
  ...
  this.level = 0;
  const s3 = this.src;
  for (let start = 0, pos = 0, indent = 0, offset = 0, len = s3.length, indent_found = false; pos < len; pos++) {
    const ch = s3.charCodeAt(pos);
    if (!indent_found) {
      if (isSpace(ch)) {
        indent++;
        if (ch === 9) {
...
StateBlock.prototype.getLines = function getLines(begin, end, indent, keepLastLF) {
  ...
  for (let i4 = 0, line = begin; line < end; line++, i4++) {
    let lineIndent = 0;
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_block/table.mjs
...
function escapedSplit(str) {
  ...
  while (pos < max) {
    if (ch === 124) {
      if (!isEscaped) {
        result3.push(current + str.substring(lastPos, pos));
        current = "";
        lastPos = pos + 1;
      } else {
  ...
  result3.push(current + str.substring(lastPos));
  return result3;
}
function table(state, startLine, endLine, silent) {
  ...
  for (let i4 = 0; i4 < columns.length; i4++) {
    ...
    if (aligns[i4]) {
      token_ho.attrs = [["style", "text-align:" + aligns[i4]]];
    }
    const token_il = state.push("inline", "", 0);
    token_il.content = columns[i4].trim();
    token_il.children = [];
  ...
  for (nextLine = startLine + 2; nextLine < endLine; nextLine++) {
    ...
    let terminate = false;
    for (let i4 = 0, l3 = terminatorRules.length; i4 < l3; i4++) {
    ...
    for (let i4 = 0; i4 < columnCount; i4++) {
      const token_tdo = state.push("td_open", "td", 1);
      if (aligns[i4]) {
        token_tdo.attrs = [["style", "text-align:" + aligns[i4]]];
      }
      const token_il = state.push("inline", "", 0);
      token_il.content = columns[i4] ? columns[i4].trim() : "";
      token_il.children = [];
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_block/code.mjs
...
function blockquote(state, startLine, endLine, silent) {
  ...
  state.parentType = oldParentType;
  lines[1] = state.line;
  for (let i4 = 0; i4 < oldTShift.length; i4++) {
...
function markTightParagraphs(state, idx) {
  ...
  for (let i4 = idx + 2, l3 = state.tokens.length - 2; i4 < l3; i4++) {
...
function reference(state, startLine, _endLine, silent) {
  ...
  function getNextLine(nextLine2) {
    ...
    if (!isContinuation) {
      ...
      let terminate = false;
      for (let i4 = 0, l3 = terminatorRules.length; i4 < l3; i4++) {
        if (terminatorRules[i4](state, nextLine2, endLine, true)) {
          terminate = true;
          break;
        }
      }
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/common/html_blocks.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/common/html_re.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_block/html_block.mjs
var HTML_SEQUENCES = [
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_block/lheading.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_block/paragraph.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/parser_block.mjs
var _rules2 = [
...
function ParserBlock() {
  this.ruler = new ruler_default();
  for (let i4 = 0; i4 < _rules2.length; i4++) {
    this.ruler.push(_rules2[i4][0], _rules2[i4][1], { alt: (_rules2[i4][2] || []).slice() });
  }
}
...
ParserBlock.prototype.parse = function(src, md3, env, outTokens) {
  ...
  const state = new this.State(src, md3, env, outTokens);
  this.tokenize(state, state.line, state.lineMax);
};
ParserBlock.prototype.State = state_block_default;
var parser_block_default = ParserBlock;

// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/state_inline.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/text.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/linkify.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/newline.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/escape.mjs
var ESCAPED = [];
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/backticks.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/strikethrough.mjs
...
function postProcess(state, delimiters) {
  ...
  while (loneMarkers.length) {
    ...
    if (i4 !== j3) {
      ...
      state.tokens[j3] = state.tokens[i4];
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/emphasis.mjs
function emphasis_tokenize(state, silent) {
  ...
  for (let i4 = 0; i4 < scanned.length; i4++) {
...
function postProcess2(state, delimiters) {
  ...
  for (let i4 = max - 1; i4 >= 0; i4--) {
    ...
    const endDelim = delimiters[startDelim.end];
    const isStrong = i4 > 0 && delimiters[i4 - 1].end === startDelim.end + 1 && // check that first two markers match and adjacent
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/link.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/image.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/autolink.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/html_inline.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/entity.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/rules_inline/fragments_join.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/parser_inline.mjs
var _rules3 = [
  ["text", text],
  ["linkify", linkify2],
  ["newline", newline],
...
function ParserInline() {
  this.ruler = new ruler_default();
  for (let i4 = 0; i4 < _rules3.length; i4++) {
    this.ruler.push(_rules3[i4][0], _rules3[i4][1]);
  }
  this.ruler2 = new ruler_default();
  for (let i4 = 0; i4 < _rules22.length; i4++) {
    this.ruler2.push(_rules22[i4][0], _rules22[i4][1]);
  }
}
...
ParserInline.prototype.parse = function(str, md3, env, outTokens) {
  const state = new this.State(str, md3, env, outTokens);
  this.tokenize(state);
...
// ../../../.cache/deno/deno_esbuild/linkify-it@5.0.0/node_modules/linkify-it/lib/re.mjs
...
// ../../../.cache/deno/deno_esbuild/linkify-it@5.0.0/node_modules/linkify-it/index.mjs
...
LinkifyIt.prototype.test = function test(text4) {
  ...
  if (this.re.schema_test.test(text4)) {
    ...
    while ((m2 = re.exec(text4)) !== null) {
      len = this.testSchemaAt(text4, m2[2], re.lastIndex);
      if (len) {
...
LinkifyIt.prototype.testSchemaAt = function testSchemaAt(text4, schema, pos) {
  if (!this.__compiled__[schema.toLowerCase()]) {
    return 0;
  }
  return this.__compiled__[schema.toLowerCase()].validate(text4, pos, this);
};
LinkifyIt.prototype.match = function match(text4) {
  const result3 = [];
  let shift = 0;
  if (this.__index__ >= 0 && this.__text_cache__ === text4) {
    result3.push(createMatch(this, shift));
...
LinkifyIt.prototype.matchAtStart = function matchAtStart(text4) {
  ...
  const m2 = this.re.schema_at_start.exec(text4);
  if (!m2) return null;
  const len = this.testSchemaAt(text4, m2[2], m2[0].length);
  if (!len) return null;
  this.__schema__ = m2[2];
  this.__index__ = m2.index + m2[1].length;
  this.__last_index__ = m2.index + m2[0].length + len;
...
// ../../../.cache/deno/deno_esbuild/punycode.js@2.3.1/node_modules/punycode.js/punycode.es6.js
...
function map(array, callback) {
  ...
  while (length--) {
    result3[length] = callback(array[length]);
  }
  return result3;
}
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/presets/default.mjs
var default_default = {
  options: {
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/presets/zero.mjs
var zero_default = {
  options: {
    // Enable HTML tags in source
    html: false,
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/presets/commonmark.mjs
...
// ../../../.cache/deno/deno_esbuild/markdown-it@14.1.0/node_modules/markdown-it/lib/index.mjs
var config = {
...
MarkdownIt.prototype.enable = function(list2, ignoreInvalid) {
  ...
  ["core", "block", "inline"].forEach(function(chain) {
    result3 = result3.concat(this[chain].ruler.enable(list2, true));
  }, this);
  result3 = result3.concat(this.inline.ruler2.enable(list2, true));
  const missed = list2.filter(function(name) {
    return result3.indexOf(name) < 0;
  });
...
MarkdownIt.prototype.disable = function(list2, ignoreInvalid) {
  ...
  ["core", "block", "inline"].forEach(function(chain) {
    result3 = result3.concat(this[chain].ruler.disable(list2, true));
  }, this);
  result3 = result3.concat(this.inline.ruler2.disable(list2, true));
  const missed = list2.filter(function(name) {
    return result3.indexOf(name) < 0;
  });
  if (missed.length && !ignoreInvalid) {
...
// src/doc/installdoc.ts
var md = lib_default();
var text2 = await fetch("./markdowns/Install.md");
var markdown = await text2.text();
var result = md.render(markdown);

// src/doc/usagedoc.ts
var md2 = lib_default();
var text3 = await fetch("./markdowns/Usage.md");
var markdown2 = await text3.text();
var result2 = md2.render(markdown2);
...
`;
var GoPreNextNav = mod_default.nav`
  display: block;
`;
var GoPreNextA = mod_default.button`
  border: 0px;
  cursor: pointer;
  padding: 14px 20px;
  text-decoration: none;
...
`;
var MarkdownAreaCSS = mod_default.div`
  & pre {
    padding: 10px;
...
`;
var documentKeys = [];
var documentIndex = /* @__PURE__ */ new Map();
documentIndex.set("install", result);
documentKeys.push("install");
documentIndex.set("usage", result2);
documentKeys.push("usage");
var StringToDomComponent = ({ htmlString }) => {
  return /* @__PURE__ */ u2(MarkdownAreaCSS, { dangerouslySetInnerHTML: { __html: htmlString } });
};
function Header() {
  return /* @__PURE__ */ u2(DocTopBar, { children: [
...
function Doc() {
  ...
  const [selected, setSelected] = h2("install");
  const toggleOpen = () => {
    setIsOpen(!isOpen);
  };
  const sidebarList = [];
  documentKeys.forEach((key) => {
    sidebarList.push(
      /* @__PURE__ */ u2(LeftA, { selected: key == selected, onClick: () => setSelected(key), children: key })
    );
  });
  const next = () => {
